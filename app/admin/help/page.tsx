...
npx tsx prisma/seed.ts      # create admin user from .env`}</Code>
        ...
        <Section id="categories" title="2. Categories & Tags">
          ...
          <p className="mt-3 text-gray-600 text-sm leading-relaxed">
            <strong>/admin/categories</strong> &rarr; &quot;New category&quot;: fill in Name, Slug (auto-generated), and optionally Description (shown on the category page).
          </p>
          <p className="mt-3 text-gray-600 text-sm leading-relaxed">
        ...
        <Section id="links" title="3. Affiliate Links">
          ...
          <ol className="list-decimal list-inside space-y-1.5 text-sm text-gray-600">
            ...
            <li>Click the affiliate link button &rarr; a search box appears</li>
        ...
        <Section id="articles" title="4. Articles">
          ...
          <Table
            ...
            rows={[
              ...
              ["v", "Callout block - tip / warning / info / note"],
            ]}
          />
          ...
          <Table
            ...
            rows={[
              ["Hero (horizontal)", "1200x630px", "16:9"],
        ...
        <Section id="callouts" title="6. Callout Blocks">
          <p className="text-sm text-gray-600 mb-4">
            In the toolbar - the warning icon button (v). Choose a type:
          </p>
          <Table
            headers={["Type", "Color", "When to use"]}
            rows={[
              ["Tip", "Green", "Useful advice, life hack"],
              ["Warning", "Yellow", "Caution, \"don't do this\""],
              ["Info", "Blue", "Reference information, clarification"],
        ...
        <Section id="pinterest" title="8. Pinterest Workflow">
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
            ...
            <li>Click &quot;Save&quot; &rarr; Pinterest opens with a ready pin: image + description + article link</li>
...
function Callout({ type, children }: { type: "tip" | "info" | "warning" | "note"; children: React.ReactNode }) {
  const styles = {
    ...
    info:    { bg: "bg-blue-50",   border: "border-blue-400",  label: "Info",    text: "text-blue-800"  },
    warning: { bg: "bg-amber-50",  border: "border-amber-400", label: "Warning", text: "text-amber-800" },
